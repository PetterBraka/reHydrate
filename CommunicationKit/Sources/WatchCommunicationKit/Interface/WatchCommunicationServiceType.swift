...
public protocol WatchServiceType {
    ...
    func send(message: [String : Any], replyHandler: (([String : Any]) -> Void)?, errorHandler: ((any Error) -> Void)?)
    func send(messageData data: Data, replyHandler: ((Data) -> Void)?, errorHandler: ((any Error) -> Void)?)
