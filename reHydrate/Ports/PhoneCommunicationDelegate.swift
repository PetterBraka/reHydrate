//
//  PhoneCommunicationDelegate.swift
//  reHydrate
//
//  Created by Petter vang Brakalsvålet on 04/08/2024.
...
final class PhoneCommunicationDelegate: NSObject {
...
extension PhoneCommunicationDelegate: WCSessionDelegate {
...
extension PhoneCommunicationDelegate {
    public func session(
        _ session: WCSession,
